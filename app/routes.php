...
return function (SlimApp $app): void {
    ...
    $app->group('/tlgBot', function (): void {
        ...
        $this->patch('/account/charge', App\Controllers\TelegramBotController::class . ':accountCharge');
        $this->post('/account/beAgent', App\Controllers\TelegramBotController::class . ':beAgent');
