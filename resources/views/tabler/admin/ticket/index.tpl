...
<div class="page-wrapper">
    <div class="container-xl">
        <div class="page-header d-print-none text-white">
            <div class="row align-items-center">
                <div class="col">
                    <h2 class="page-title">
                        <span class="home-title">Workers single-row table</span>
                    </h2>
                    <div class="page-pretitle my-3">
                        <span class="home-subtitle">Check and reply the user work order</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function closeTicket(ticket_id) {
            $('#notice-message').text('Sure close this work order?');
        ...
        function deleteTicket(ticket_id) {
            $('#notice-message').text('Sure to delete this order?');
            $('#notice-dialog').modal('show');
            $('#notice-confirm').on('click', function() {
                $.ajax({
