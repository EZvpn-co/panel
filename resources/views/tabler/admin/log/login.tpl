    ...
    <div class="container-xl">
        <div class="page-header d-print-none text-white">
            <div class="row align-items-center">
                <div class="col">
                    <h2 class="page-title">
                        <span class="home-title">The loginIP</span>
                    </h2>
                    <div class="page-pretitle my-3">
                        <span class="home-subtitle">Check user account login record</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        var table = $('#data_table').DataTable({
            ...
            language: {
                ...
                "sInfoEmpty": "The first 0 to 0 A result, altogitemther 0 item",
