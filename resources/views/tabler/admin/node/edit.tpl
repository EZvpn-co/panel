                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mb-3 row">
                                ...
                                <label class="form-label col-form-label">
                                    Please refer to the <a href="//wiki.sspanel.org/#/setup-custom-config" target="_blank">wiki.sspanel.org/#/setup-cuModify the node custom configurationsig</a> Modify the node custom configurations
                                </label>
                            </div>
                            <div class="mb-3">
                                <div class="divide-y">
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mb-3 row">
                                <label class="form-label col-3 col-form-label">Have used traffic (GB)</label>
                                <div class="col">
                            ...
                            <div class="form-group mb-3 row">
                                ...
                                <div class="row my-3">
                                    <div class="col">
                                        <button id="reset-node-password" class="btn btn-red">reset</button>
                                ...
                                <label class="form-label col-form-label">
                                    Communication key to gRPC API Authentication, if you want to change, please click reset
                                </label>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    $(".copy-text").click(function () {
        $('#success-message').text('Have been copied to your clipboard.');
